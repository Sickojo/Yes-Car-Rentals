...
#include <memory>
#include "../../YES-Car-Rentals/editcarwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EditCarWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EditCarWindow_t qt_meta_stringdata_EditCarWindow = {
    {
QT_MOC_LITERAL(0, 0, 13), // "EditCarWindow"
QT_MOC_LITERAL(1, 14, 24), // "on_changeCarButt_clicked"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "EditCarWindow\0on_changeCarButt_clicked\0"
    ""
};
...
void EditCarWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditCarWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EditCarWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_EditCarWindow.data,
    qt_meta_data_EditCarWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EditCarWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EditCarWindow.stringdata0))
